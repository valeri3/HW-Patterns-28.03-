...
public:
 ...
 void main()
 {
	 ...
	 while (counter < 10)
	 {
		 cout << "Выберите тип компьютера для создания:" << endl;
		 cout << "1. Домашний PC" << endl;
		 cout << "2. Офисный PC" << endl;
		 cout << "3. Игровой PC" << endl;
		 cout << "Ваш выбор: ";
		 cin >> choice;
		 ...
		 if (cin.fail() || choice < 1 || choice > 3) 
		 {
			 ...
			 cin.clear(); 
			 cin.ignore(numeric_limits<streamsize>::max(), '\n'); // Игнорировать оставшийся вход до новой строки

			 continue; 
		 }

		 PC* pc = creators[choice - 1]->FactoryMethod(); // Создаем компьютер выбранного типа
		 pc->ShowPC(); 
